...
def bangun(uname):
    global data_bahan_bangunan, data_candi
    ...
    if need_bahan[0] > sum_pasir or need_bahan[1] > sum_batu or need_bahan[2] > sum_air:
        ...
        for iter in range(101):
            if data_candi[iter] == None:
                # Melakukan perubahan data pada Array data_candi di index [iter].
                ...
                break
            if iter == 100:
                # Menampilkan output ke layar tanpa merubah data pada array data_candi.
                print("Candi berhasil dibangun")
